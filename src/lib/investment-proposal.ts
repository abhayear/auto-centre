...
export const INVESTMENT_PROPOSAL = {
  ...
  subtitle: `${SITE_NAME} — Yakuza Electric 2-Wheeler Sales & Service`,
  lastUpdated: "June 2026",
  confidentialNotice:
    "Confidential — for qualified investors and strategic partners only.",

  executiveSummary: `${SITE_NAME} is an established Yakuza electric 2-wheeler dealership and service centre in Lalitpur, Uttar Pradesh. We combine showroom sales, EV-specialist workshop services, and doorstep service coverage — positioning us to capture growing demand for affordable electric mobility across Bundelkhand.`,

  highlights: [
    { label: "E-Scooters Sold", value: "300+" },
    { label: "Location", value: "Civil Line, Lalitpur" },
    { label: "Channels", value: "Showroom + Service" },
  ...
  companyOverview: {
    ...
    paragraphs: [
      `${SITE_NAME} operates from ${SITE_ADDRESS}, serving riders across Lalitpur and surrounding districts with Yakuza electric scooter sales, test rides, financing guidance, and full EV after-sales support.`,
      "Our workshop handles battery diagnostics, motor service, brake work, and scheduled maintenance — with dedicated expertise for Yakuza e-scooters and lithium-ion platforms.",
    ],
  },
  ...
  businessModel: {
    ...
    streams: [
      {
        title: "Yakuza EV Sales",
        detail: "Margin on new Yakuza vehicle sales, test-ride conversion, and financing support.",
      },
      {
      ...
      },
      {
        ...
        detail: "Booked service visits across our validated service area with GPS routing.",
      },
      {
  ...
  traction: {
    ...
    items: [
      ...
      "Authorized Yakuza sales and service operations with EV-trained technicians",
    ...
    phases: [
      {
        ...
        goals: [
          "Expand Yakuza EV inventory and accessories",
          "Scale local marketing and showroom walk-in conversion",
