...
export function VisitorCountBadge() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="mt-6 inline-flex items-center gap-2 rounded-full border border-slate-600/60 bg-slate-900/60 px-4 py-2 text-sm text-slate-300 backdrop-blur-sm"
    >
