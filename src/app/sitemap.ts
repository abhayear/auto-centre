...
const STATIC_PATHS = [
  ...
  { path: "/refer-mechanic", changeFrequency: "monthly" as const, priority: 0.5 },
  ...
  { path: "/refund-policy", changeFrequency: "yearly" as const, priority: 0.5 },
  { path: "/shipping", changeFrequency: "yearly" as const, priority: 0.5 },
